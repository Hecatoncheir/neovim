return {
    {
        ...
        config = function()
            require('go').setup({
                ...
                gopls_cmd = "gopls",      -- if you need to specify gopls path and cmd, e.g {"/home/user/lsp/gopls", "-logfile","/var/log/gopls.log" }
        ...
        opts = {
            servers = {
                gopls = {
                    ...
                    -- { "<leader>td", "<cmd>lua require('dap-go').debug_test()<CR>", desc = "Debug Nearest (Go) test" },
                    -- },
                    settings = {
                        gopls = {
                            gofumpt = true,
